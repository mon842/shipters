    ...
    return (
        ...
        <footer className="bg-black dark:bg-white">
            <div className="mx-auto w-full max-w-screen-xl">
                ...
                <div className="grid grid-cols-2 gap-1 px-5 py-10 lg:py-20 md:grid-cols-5">
                    
                    <div>
                        <h2 className="mb-6 text-sm font-semibold text-gray-200 uppercase dark:text-gray-800">Company</h2>
                        <ul className="text-gray-200 dark:text-gray-400 text-xs">
                            <li className="mb-2">
                    ...
                    <div>
                        <h2 className="mb-6 text-sm font-semibold text-gray-200 uppercase dark:text-gray-800">Help center</h2>
                        <ul className="text-gray-200 dark:text-gray-400 text-xs">
                            <li className="mb-2">
                    ...
                    <div>
                        <h2 className="mb-6 text-sm font-semibold text-gray-200 uppercase dark:text-gray-800">Legal</h2>
                        <ul className="text-gray-200 dark:text-gray-400 text-xs">
                            <li className="mb-2">
                    ...
                    <div>
                        <h2 className="mb-6 text-sm font-semibold text-gray-200 uppercase dark:text-gray-800">Download</h2>
                        <ul className="text-gray-200 dark:text-gray-400 text-xs">
                            <li className="mb-2">
                    ...
                    <div className="flex mt-4 space-x-5 sm:justify-center md:mt-0">
                        <a href="#" className="rounded-3xl h-8 w-8 p-1  bg-gray-400 hover:bg-gray-100 dark:hover:text-white">
